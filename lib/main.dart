...
import 'buyer/AgriSynchBuyerProfileWeb.dart';
...
void main() async {
  ...
  // Configure URL strategy for web to enable browser back button
  if (kIsWeb) {
    usePathUrlStrategy();
  }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/buyer-profile-complete': (context) => const AgriSynchBuyerProfileWeb(),
