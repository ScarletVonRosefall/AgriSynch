...
class AgriFinances
  ...
  State<
    AgriFinances
  >
  createState() => _AgriFinancesState();
}

class _AgriFinancesState
    extends
        State<
          AgriFinances
        > {
  ...
  void _loadTransactions() async {
    ...
    final savedTransactions = prefs.getString(
    ...
    return sortedCategories
        ...
        .map(
          (
            ...
            final index = sortedCategories.indexOf(
              entry,
            );
  ...
  Widget build(
    ...
    final backgroundColor = ThemeHelper.getBackgroundColor(
      isDarkMode,
    );
...
class AddTransactionDialog
  ...
  >
  createState() => _AddTransactionDialogState();
}
                ...
                child: Column(
                  children: [
                    ...
                    >(
                      ...
                      items: categoryMap[selectedType]!.map(
                        (
                          category,
                        ) {
                          return DropdownMenuItem(
