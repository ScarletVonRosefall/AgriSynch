...
class ThemeHelper {
  ...
  static Color getHeaderColor(bool isDark) => 
  ...
  static ButtonStyle getPrimaryButtonStyle({required bool isDark}) {
    return ElevatedButton.styleFrom(
      backgroundColor: isDark ? const Color(0xFF4CAF50) : const Color(0xFF00C853),
  ...
  static ButtonStyle getSecondaryButtonStyle({required bool isDark}) {
    return ElevatedButton.styleFrom(
      backgroundColor: isDark ? const Color(0xFF4CAF50) : const Color(0xFFDCE775),
