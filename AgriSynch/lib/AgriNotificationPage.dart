...
class AgriNotificationPage
  ...
  @override
  State<
    AgriNotificationPage
  >
  createState() => _AgriNotificationPageState();
}

class _AgriNotificationPageState
    extends
        State<
          AgriNotificationPage
        > {
  ...
  markAsRead(
    ...
    await NotificationHelper.markAsRead(
      notificationId,
    );
  ...
  Widget _buildNotificationCard(
    ...
    final type =
        notification['type'] ??
        'system';
    final icon = NotificationHelper.getNotificationIcon(
      type,
    );
